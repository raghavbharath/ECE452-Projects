...
cfg.hiddenSizes = [128 64]; % change vector length to change #hidden layers
cfg.hiddenAct   = "logsig"; % "tansig" | "logsig" | "poslin"
cfg.epochs      = 100;
...
export.preprocess.gain   = net.inputs{1}.processSettings{1}.gain;
export.preprocess.offset = net.inputs{1}.processSettings{1}.xoffset;
